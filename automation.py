...
def extract_from_html():
    ...
    index = tables_dict[TABS_TABLE][0].index(TABS_COLUMN)

    #creating the tabs
    # spreadsheet.create_tabs([v[index] for v in tables_dict[TABS_TABLE][1:]])
    return tables_dict
...
def main():
    ...
    # calling the function to populate the spreadsheet
    spreadsheet.populate_data_to_spreadsheet(tables_dict)
